...
<p>Процессы отличаются уникальным типом активностей: различные типы голосования, совместная работа над репозиториями проекта и др.</p>

<p>Второй обязательный блок процесса это обсуждение.</p>

<p>Процессы проектов на которые подписан пользователь появляются в его TODO менеджере. Они сортируются по дате активности в них. Можно отфильтровать процессы по трем параметрам: процессы требующие внимания пользователя (например, ему написали в обсуждении процесса), открытые процессы проектов на которые подписан пользователь, а так же завершенные процессы проектов на которые подписан пользователь.</p>
